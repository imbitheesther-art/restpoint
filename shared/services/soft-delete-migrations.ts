 ...
 */
export const SOFT_DELETE_MIGRATIONS: Migration[] = [
...
export const SOFT_DELETE_QUERIES = {
     ...
     */
    hardDelete: (tableName: string, primaryKey: string = 'id') =>
        `DELETE FROM ${tableName} WHERE ${primaryKey} = ?`,

    /**
     * Filter query to exclude soft-deleted records
     */
    excludeDeleted: (tableName: string = '') =>
        `${tableName ? tableName + '.' : ''}is_deleted = FALSE`,

    /**
     * Get only soft-deleted records
     */
    onlyDeleted: (tableName: string = '') =>
