...
async function handleDeceasedNotifications(io = null) {
  ...
  try {
    ...
    for (const person of receivedDeceased) {
      ...
      await insertNotification(deceased_id, 'balance_update', balanceMessage, io);
    }
...
async function insertNotification(deceased_id, type, message, io = null) {
...
async function markAllNotificationsAsRead(req, res) {
  try {
    await safeQuery(`UPDATE notifications SET is_read = 1`);
