...
-- Deceased table - Updated with all required fields
CREATE TABLE IF NOT EXISTS deceased (
    id INT AUTO_INCREMENT PRIMARY KEY,
    deceased_id VARCHAR(50) UNIQUE NOT NULL,
    tenant_slug VARCHAR(255) NOT NULL,
    ...
    body_status VARCHAR(100) DEFAULT 'In Morgue',
    national_id VARCHAR(100) NULL,
    id_type ENUM('national-id', 'passport', 'voters-card', 'other') NULL,
    email VARCHAR(255) NULL,
    phone_number VARCHAR(20) NULL,
    alternative_phone VARCHAR(20) NULL,
    received_from VARCHAR(255) NULL,
    receiving_officer VARCHAR(255) NULL,
    signature TEXT NULL,
    ...
    chamber_assigned VARCHAR(100) NULL,
    total_mortuary_charge DECIMAL(10, 2) DEFAULT 0,
    coffin_status VARCHAR(50) NULL,
...
-- Next of Kin table - Updated with all required fields
