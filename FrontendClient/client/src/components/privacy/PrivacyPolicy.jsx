    ...
    <div style={{ fontFamily: "'Inter', sans-serif", background: C.navy50, minHeight: '100vh' }}>
      ...
      <div style={{ maxWidth: '800px', margin: '0 auto', padding: '2rem 1.5rem', lineHeight: 1.8 }}>
        ...
        <div style={{ background: 'rgba(166,124,82,0.06)', border: `1px solid rgba(166,124,82,0.2)`, borderRadius: '10px', padding: '1.25rem', marginBottom: '2rem' }}>
          <p style={{ color: C.char700, fontSize: '0.9rem' }}>This policy explains how Rest Point collects, uses, and protects your personal data. We are committed to transparency and giving you control over your information. Questions? Contact <a href="mailto:privacy@restpoint.co.ke" style={{ color: C.gold }}>privacy@restpoint.co.ke</a>.</p>
        </div>
