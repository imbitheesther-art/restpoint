...
-- Centralized from services/hearse-service/migrations/004_simplified_schema.sql
...
CREATE TABLE hearses (
    ...
    status ENUM('available', 'booked', 'cancelled', 'in_transit', 'maintenance', 'unavailable') DEFAULT 'available',
...
CREATE TABLE hearse_bookings (
    ...
    status ENUM('pending', 'confirmed', 'in_progress', 'completed', 'cancelled', 'booked', 'in_transit', 'postponed', 'maintenance') DEFAULT 'pending',
    driver_id INT,
    branch_id INT DEFAULT 1,
